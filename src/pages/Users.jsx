...
const Users = () => {
    ...
    return (
        <Stack dir='column' justifyContent={'flex-start'} alignItems={'flex-start'} gap={3} w={'100%'} h='100%'>
            <Heading color={'dark_text'} fontSize={{ base: '1.5rem', md: '2rem' }}>Usuarios</Heading>
            <Text color={'text'} fontSize={{ base: '0.8rem', md: '1.2rem' }}>Listado de todos los usuarios del sistema</Text>
            ...
            </Stack>
            {
                (!dataUsers || dataUsers.length === 0) && (
                    <Text color={'text'} fontSize={{ base: '0.8rem', md: '1.2rem' }}>No se han creado usuarios</Text>
                )
            }
            {
                dataUsers && dataUsers.length > 0 && (
