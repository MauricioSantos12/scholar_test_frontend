import { Button, Container, Heading, ListItem, Stack, Text, UnorderedList } from '@chakra-ui/react'
import React from 'react'
import UniIcon from '../../utils/UniIcon';

const InitialView = ({ completeTest, setStep, fetchTests, user, setTestResult, setStartTime, startTime, currentQuestion, totalQuestions, remainingTime, formatTime, typeTest, style }) => {
